<template>
    <div>
           <el-select v-model="selectCityData.selectProvince" placeholder="请选择" @change="provinceChange(selectCityData.selectProvince)" style="width: 30%" @click="provinceChange">
               <el-option v-for="item in province" :key="item.value" :label="item.label" :value="item.value">
               </el-option>
           </el-select>
           <el-select v-model="selectCityData.selectCity" placeholder="请选择"  @change="selectCityChange(selectCityData.selectCity)"  style="width: 30%">
               <el-option v-for="item in city" :key="item.value" :label="item.label" :value="item.value">
               </el-option>
           </el-select>
           <el-select v-model="selectCityData.selectArea" placeholder="请选择" @change="selectAreaChange(selectCityData.selectArea)"  style="width: 30%">
