                            ...
                            <el-row :span="24">
                                <el-col :span="6">
                                    <el-form-item label="岗位名称" label-width="23%">
                                        <el-input v-model="formData.postName" placeholder="请输入用户角色"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-form-item>
                                ...
                                <!-- 右侧按钮 -->
                                <div class="btn-right">
                                    <el-button v-show="userButtonCodes.handleDownload" type="primary" size="small" @click="handleDownload()" id="output">导出</el-button>
                                    <!-- 字段显示开始 -->
        ...
        <el-dialog :append-to-body="true" class="dialog" title="编辑岗位信息"  :close-on-click-modal="true" :visible.sync="editFormVisible"  width="33%" top="10%">
            <div class="fromBox">
                <el-form :model="editForm" ref="editForm"  label-width="18%">
                    ...
                    postRemarkAdd:''    // 岗位备注-->
                    <el-form-item label="岗位名称" >
                        <el-input v-model="editForm.postNameEdit" placeholder="请输入岗位名称"></el-input>
                    </el-form-item>
                    <el-form-item label="岗位状态">
                        <el-select v-model="editForm.postStatusEdit">
                            <el-option v-for="item in editFormSelect.postStatusSelect" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="岗位备注">
                        <el-input type="textarea" v-model="editForm.postRemarkEdit" :autosize="{ minRows: 3, maxRows: 4}" placeholder="请输入备注"></el-input>
                    </el-form-item>
                </el-form>
                <div slot="footer" class="dialog-footer">
  ...
  methods: {
    ...
    edit () { // 编辑
      ...
      if (sele.length >= 2) {
        ...
        this.editForm.id = sele[0].id
        this.editForm.postNameEdit = sele[0].postName
        this.editForm.postStatusEdit = status
        this.editForm.postRemarkEdit = sele[0].remark
      }
    },
    editSubmit () { // 确定编辑
      let status
      ...
      status = this.editForm.postStatusEdit
      ...
      let data = {
        'id': this.editForm.id,
        'name': this.editForm.postNameEdit,
        'description': this.editForm.postRemarkEdit,
        'disable': status
      }
